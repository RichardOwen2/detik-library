...
<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center"
                    ...
                    <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                            ...
                            <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate"
                                id="kt_sign_up_form"
                                data-kt-redirect-url="/metronic8/demo44/authentication/layouts/overlay/sign-in.html"
                                action="#">
                                <!--begin::Heading-->
                                ...
                                <div class="row g-3 mb-9">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a href="#"
                                            ...
                                            <img alt="Logo"
                                                src="{{ asset('metronic') }}/media/svg/brand-logos/apple-black-dark.svg"
                                ...
                                <div class="text-gray-500 text-center fw-semibold fs-6">
                                    ...
                                    <a href="/metronic8/demo44/authentication/layouts/overlay/sign-in.html"
                        ...
                        <div class="w-lg-500px d-flex flex-stack">
                            ...
                            <div class="me-10">
                                ...
                                <button
                                    ...
                                    <img data-kt-element="current-lang-flag" class="w-20px h-20px rounded me-3"
                                        src="{{ asset('metronic') }}/media/flags/united-states.svg" alt="">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4 fs-7"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link d-flex px-5" data-kt-lang="Spanish">
                                            <span class="symbol symbol-20px me-4">
                                                <img data-kt-element="lang-flag" class="rounded-1"
                                                    src="{{ asset('metronic') }}/media/flags/spain.svg"
                                                    alt="">
                                            </span>
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link d-flex px-5" data-kt-lang="German">
                                            <span class="symbol symbol-20px me-4">
                                                <img data-kt-element="lang-flag" class="rounded-1"
                                                    src="{{ asset('metronic') }}/media/flags/germany.svg"
                                                    alt="">
                                            </span>
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link d-flex px-5" data-kt-lang="Japanese">
                                            <span class="symbol symbol-20px me-4">
                                                <img data-kt-element="lang-flag" class="rounded-1"
                                                    src="{{ asset('metronic') }}/media/flags/japan.svg"
                                                    alt="">
                                            </span>
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="#" class="menu-link d-flex px-5" data-kt-lang="French">
                                            <span class="symbol symbol-20px me-4">
                                                <img data-kt-element="lang-flag" class="rounded-1"
                                                    src="{{ asset('metronic') }}/media/flags/france.svg"
                                                    alt="">
                                            </span>
                            ...
                            <div class="d-flex fw-semibold text-primary fs-base gap-5">
                                <a href="/metronic8/demo44/pages/team.html" target="_blank">Terms</a>

                                <a href="/metronic8/demo44/pages/pricing/column.html" target="_blank">Plans</a>

                                <a href="/metronic8/demo44/pages/contact.html" target="_blank">Contact Us</a>
                            </div>
                            <!--end::Links-->
                        </div>
                        <!--end::Footer-->
    ...
    <script src="{{ asset('metronic') }}/js/custom/authentication/sign-up/general.js"></script>
</body>
